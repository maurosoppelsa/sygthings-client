...
export default function NewSightComponent({ onPressCameraBt, isCameraActive, onTakePicture, newPicture, newSightStatus, showModal, onSightSubmit, onFormClose, imageUrl, locationName }:
    { onPressCameraBt: any, isCameraActive: boolean, onTakePicture: any, newPicture: Picture, newSightStatus: string, showModal: boolean, onSightSubmit: any, onFormClose: any, imageUrl: string, locationName: string }) {
    return (
        !isCameraActive ? <ImageBackground source={{ uri: imageUrl }} resizeMode="cover" style={styles.image}>
            ...
            <Box style={styles.container}>
                <Box style={styles.boxContent}>
                    <LocationDetailsComponent locationName={locationName}/>
